...
public final class TankerEnemyDrawer implements EntityDrawer {
	...
	public void draw(long tickCount, @Nonnull GraphicsContext graphicsContext, @Nonnull GameEntity entity, double screenPosX, double screenPosY, double screenWidth, double screenHeight, double zoom) {
		...
		try {
			...
			graphicsContext.fillRect(screenPosX, screenPosY -20, ((double)enemy.getHealth() /(double)Config.TANKER_ENEMY_HEALTH)*Config.TILE_SIZE*Config.TANKER_ENEMY_SIZE,14);
